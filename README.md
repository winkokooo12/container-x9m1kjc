...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x9m1kjc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x9m1kjc.containers.anotherwebservice.com/
...
```
git clone git@github.com:winkokooo12/container-x9m1kjc.git
cd container-x9m1kjc
```
...
```
docker attach container-x9m1kjc
```
